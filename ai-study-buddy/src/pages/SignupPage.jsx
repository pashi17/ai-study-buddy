...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-[#060b1a] grid-bg flex items-center justify-center px-4 py-12 relative overflow-hidden">
      <div className="orb orb-purple w-[500px] h-[500px] top-[-150px] left-[-100px] opacity-25" />
      <div className="orb orb-teal w-[400px] h-[400px] bottom-[-100px] right-[-100px] opacity-20" />
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-ink-400 font-body text-sm">Free forever · No credit card required</p>
        </div>
        ...
        <div className="glass-card p-8">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-xs text-ink-500 font-body">or with email</span>
            <div className="flex-1 h-px bg-ink-600/30" />
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <User size={15} className="absolute left-4 top-1/2 -translate-y-1/2 text-ink-500" />
                <input
                  type="text"
                  value={form.name}
              ...
              {form.password && (
                <div className="mt-2 space-y-1">
                  {passChecks.map(c => (
                    <div
                      key={c.label}
                      className={`flex items-center gap-2 text-xs font-body transition-colors ${c.test(form.password) ? 'text-sage-400' : 'text-ink-500'
                        }`}
                    >
                      <CheckCircle size={11} className={c.test(form.password) ? 'opacity-100' : 'opacity-30'} />
                      {c.label}
                    </div>
                  ))}
                </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`input-field pl-11 ${form.confirm && form.confirm !== form.password ? 'border-coral-500/60' : ''
                    }`}
                  required
                />
              </div>
              {form.confirm && form.confirm !== form.password && (
                <p className="text-xs text-coral-400 font-body mt-1.5">Passwords don't match</p>
              )}
            </div>
          ...
          <p className="text-center text-xs text-ink-500 font-body mt-4">
            By signing up you agree to our{' '}
            <a href="#" className="text-ink-400 hover:text-white">Terms</a> and{' '}
            <a href="#" className="text-ink-400 hover:text-white">Privacy Policy</a>
          </p>

          <p className="text-center text-sm text-ink-400 font-body mt-4">
